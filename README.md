...
###### CodeSandbox Features:
 ...
 🤨 Terminal font space is large to use, seems no methond to change terminal theme (After [discuss](https://github.com/codesandbox/codesandbox-client/discussions/5987) with CodeSandbox developer, seems the terminal font space problem I meet is a special case(it appears in my working and personal computer). But other users do not meet this, still try to find how to fix it. Update: the strange style may caused by network, but have no ideas about why it occurs and how to fix it if you visit CodeSandbox with a limited network. )
